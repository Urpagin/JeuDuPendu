...
from choix_du_mot import solution

def main(largeur, hauteur, mot_dev):
    pygame.init()

    # Set up the display
    screen_width, screen_height = largeur, hauteur
    ...
    while running:
        ...
        bg_image = pygame.transform.scale(bg_image, (largeur, hauteur))
